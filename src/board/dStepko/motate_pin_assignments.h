...
pin_number kOutput1_PinNumber = -1; //130;  // DO_1: Extruder1_PWM
pin_number kOutput2_PinNumber = -1; //131;  // DO_2: Extruder2_PWM
...
pin_number kOutput11_PinNumber = -1; //140;  // DO_11: Heated Bed FET
...
pin_number kADC0_PinNumber  = -1; //150;  // Heated bed thermistor ADC
pin_number kADC1_PinNumber  = -1; //151;  // Extruder1_ADC
